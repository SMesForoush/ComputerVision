...
if __name__ == '__main__':
    ...
    for p1, q1 in final:
        ...
        ax2.add_artist(con)
        cv2.circle(img1, (x, y), 5, (0, 0, 255), 5)
        cv2.circle(img2, (x2, y2), 5, (0, 0, 255), 5)
    plt.savefig(output_path.format("res11.jpg"))
    cv2.imwrite("res09_corres.jpg", img1)
    cv2.imwrite("res10_corres.jpg", img2)
